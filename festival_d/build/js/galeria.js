...
// Funcion para mostrar imagen grande en galeria
function mostrarImagen(id){
    ...
    const cerrarForo = document.createElement("P");
    cerrarForo.textContent = "X";
    cerrarForo.classList.add("btn-cerrar");
    cerrarForo.onclick = function(){
        const body = document.querySelector("body");
        body.classList.remove("fijar-body");
        overlay.remove();
    }
    overlay.appendChild(cerrarForo);
